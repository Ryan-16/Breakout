...
//				}
        ...
        // left wall
        if(ball.get_x() == 0 && dir == 3)
        {
            dir = 4;
        }
        if(ball.get_x() == 0 && dir == 5)
        {
            dir = 6;
        }

        // right wall
        if(ball.get_x() == width - 1 && dir == 4)
        {
            dir = 3;
        }
        if(ball.get_x() == width - 1 && dir == 6)
        {
            dir = 5;
        }

        // top wall
        if(ball.get_y() == 0 && dir == 2)
        {
            dir = 1;
        }
        if(ball.get_y() == 0 && dir == 3)
        {
            dir = 5;
        }
        if(ball.get_y() == 0 && dir == 4)
        {
            dir = 6;
        }
